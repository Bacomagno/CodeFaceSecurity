...
import { IFaceDetecion } from 'face-api.js';
...
export class VideoPlayerService {
  ...
  constructor(private faceApiService: FaceApiService, private iFaceDetection:IFaceDetecion) {
  ...
  getLandMark = async (videoElement: any) => {
    ...
    // scoreDetec () : IFaceDetecion[] ();
  // scoreDetec= async ()=>{
  //   const {score}= this.iFaceDetection;
  //   const {scoreDate}= await score.detectAllScore(score)

  // }
scoreDetec(){
  return this.iFaceDetection.score.valueOf()
  }
