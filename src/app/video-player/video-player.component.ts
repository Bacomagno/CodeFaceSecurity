...
import { FaceDetection, IFaceDetecion } from 'face-api.js';
...
export class VideoPlayerComponent implements OnInit, OnDestroy {
  ...
  // detect:
  // scoreDetection(score){
  //   this.detect.score
  //   console.log (score)
  // }
  // score2Detection(score:number){
  //   this.faceDetection.score
  //   console.log (score)
  // }

  scoreDetect(){
    // this.faceApiService.globalFace().subscribe(
    //   (responseScore)=>{
    //     this.detect.push({
    //       // box: this.videoElement.box,
    //       score: this.stream
    ...
    //   }
    // )
    this.videoPlayerService.scoreDetec().((resp: IFaceDetecion) =>{
      console.log('score');
    })
